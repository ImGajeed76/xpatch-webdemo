...
export default tseslint.config(
  // 1. IGNORE PATTERNS: Explicitly ignore build artifacts and generated files.
  {
    ignores: [
      ...
      "**/.svelte-kit/**",
      "**/bin/**",
      "**/src/lib/paraglide/**", // Ignore auto-generated Paraglide files
    ],
  },
  ...
  // It inherits the type-aware settings from the block above.
  {
    ...
    rules: {
      ...
      // Disable navigation-without-resolve for UI library components
      "svelte/no-navigation-without-resolve": "off",
      // Disable prefer-const for Svelte files - conflicts with $props() destructuring
      "prefer-const": "off",
    },
  },
